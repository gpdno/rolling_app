...
class ProjectTasksControllerTest < ActionController::TestCase
  ...
  test "should create project_task" do
    assert_difference('ProjectTask.count') do
      post :create, project_task: { body: @project_task.body, project_thread_id: @project_task.project_thread_id, user_id: @project_task.user_id }
    end
  ...
  test "should update project_task" do
    patch :update, id: @project_task, project_task: { body: @project_task.body, project_thread_id: @project_task.project_thread_id, user_id: @project_task.user_id }
    assert_redirected_to project_task_path(assigns(:project_task))
  end
